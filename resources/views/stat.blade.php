...
<div class="container-fluid m-0 p-0 px-lg-4 h-100 d-flex flex-column">
    <div class="row justify-content-center">
        <h1 style="font-weight: 700" class="text-center text-lg-start text-md-start">Statistik Produksi</h1>
    </div>
    <div class="row flex-grow-1 align-items-center">
        ...
        <div class="col-md col-lg d-flex flex-column align-items-center mb-md-0" style="margin-bottom: 120px;">
            ...
            <div>
                <div class="bg-white shadow rounded-custom py-3" style="width: 134px; height: 205px;">
